...
let deployDir = "dist"
let serverDir = Path.getFullName "Server"
let server = Path.getFullName (serverDir </> "Server.fsproj")
let clientDir = Path.getFullName "Client"
let client = Path.getFullName (clientDir </> "Client.fsproj")
let sharedDir = Path.getFullName "Shared"
...
Target.create "Bundle" (fun _ ->
    DotNet.build id serverDir
    DotNet.build id clientDir
...
"Clean" ==> "Prepare" ==> "Run" |> ignore
"Clean" ==> "Prepare" ==> "Bundle" |> ignore
"Clean" ==> "BundleDebug" |> ignore
"Clean" ==> "Prepare" ==> "Client" |> ignore
"Clean" ==> "Prepare" ==> "Server" |> ignore
